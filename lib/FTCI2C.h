...
FTCI2C_API
FTC_STATUS WINAPI I2C_EnumDevices(FT_DEVICE_LIST_INFO_NODE* pDevicesInfo, int& len);
...
FTCI2C_API FTC_STATUS WINAPI I2C_Write_Nt_Isp_Mode(FTC_HANDLE ftHandle, PWriteDataByteBuffer pWriteDataBuffer, DWORD dwNumDataBytesToWrite,
	BOOL bDataAcknowledge, DWORD dwDataAckTimeoutmSecs);

FTCI2C_API FTC_STATUS WINAPI I2C_Write_Nt_Isp_Cmd(FTC_HANDLE ftHandle, PWriteControlByteBuffer pWriteControlBuffer,
...
FTCI2C_API FTC_STATUS WINAPI I2C_OpenByDeviceNameIndex(DWORD dwDeviceNameIndex, FTC_HANDLE *pftHandle);
FTCI2C_API FTC_STATUS WINAPI I2C_GetDeviceSerialNumber(DWORD dwDeviceNameIndex, LPSTR lpDeviceNameBuffer, DWORD dwBufferSize, LPSTR lpSerialNumberBuffer);
FTCI2C_API FTC_STATUS WINAPI I2C_GetDeviceInfo(DWORD dwDeviceNameIndex, FTC_DEVICE_INFO* pstDevInfo);
FTCI2C_API FTC_STATUS WINAPI I2C_Isp_Read(FTC_HANDLE ftHandle, BYTE SlaveAddr, BYTE * pReadBuffer, DWORD dwBytesToRead);
FTCI2C_API FTC_STATUS WINAPI I2C_Isp_Write(FTC_HANDLE ftHandle, BYTE SlaveAddr, BYTE * pWriteBuffer, DWORD dwBytesToWrite);
#ifdef __cplusplus
}
#endif
